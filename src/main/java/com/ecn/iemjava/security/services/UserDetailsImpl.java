...
public class UserDetailsImpl implements UserDetails {	private static final long serialVersionUID = 1L;
    ...
    public UserDetailsImpl(AccessRepository accessRepository) {
        UserDetailsImpl.accessRepository = accessRepository;
    }
    ...
    public static UserDetailsImpl build(User user) {
        ...
        Access access = accessRepository.findByUser(user);
